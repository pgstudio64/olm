...
- [ ] **Limite de zoom in** : définir un plafond zoom in analogue au zoom out clamp. Quand la partie visible couvre **< 2 m** (en dimension la plus courte), stop. Évite de zoomer jusqu'au pixel SVG. Analogue au `_fitViewBox × 3` pour zoom out.
